...
sys.path.insert(0, os.path.abspath('/Users/philipforget/workspace/python-readability-api/readability'))
...
project = u'Readability Python API'
copyright = u'2015, Readability, LLC'
...
html_theme_options = {
    'logo': 'chair-python.png',
    'description': "Official Python client for Readability's Parser and Reader APIs.",
    'github_user': 'arc90',
    'github_repo': 'python-readability-api',
    'travis_button': 'true',
    'github_banner': 'true',
}
html_sidebars = {
